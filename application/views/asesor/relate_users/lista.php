                                ...
                                <?php foreach ($listar as $asesor) { ?>
                                    <tr style="text-align: center">
                                        ...
                                        <td style='text-align: center'>
                                            <a href="<?php echo base_url() ?>relate_users/edit/<?= $asesor->adviser_id; ?>" title="<?php echo $this->lang->line('list_edit_assoc'); ?>"><i class="fa fa-edit fa-2x"></i></a>
                                        </td>
                                        <td style='text-align: center'>
                                            
                                            <a class='borrar' id='<?php echo $asesor->adviser_id; ?>' title='<?php echo $this->lang->line('list_delete_assoc'); ?>'><i class="fa fa-trash-o fa-2x"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++ ?>
                                <?php } ?>
